...
1.2 已完成任务过程可见化版本：视频生成时展示解析、讲稿、语音、导图、合成和拼接阶段，失败时提示具体阶段，并支持下载音频包、图片包和最终视频。版本说明见 [docs/releases/1.2.md](docs/releases/1.2.md)。
...
项目已封版 1.2，本地 Streamlit 版本可运行。PPT 生成功能已暂停，当前主线是“已有 PPT -> 讲稿 -> 语音 -> 视频”。
